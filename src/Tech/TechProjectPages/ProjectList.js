...
export const personalWebsite = {
    ...
    projectPage :{
        ...
        description: 'The website started as one of my first projects I started in software development.' +
            ' With the new semester beginning soon, I wanted a place where I was proud to point employers towards. This revamp of the website is meant to be a place to accommodate both my planning and software interests, a home for my technical projects, and an opportunity to brand myself. '
    },
};
